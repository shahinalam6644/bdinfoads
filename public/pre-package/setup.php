                            ...
                            <div class="p-5">
                                ...
                                <form action="" method="POST" class="user">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="blogurl" class="form-control form-control-user"
...
MIX_PUSHER_APP_CLUSTER="${PUSHER_APP_CLUSTER}"';
								...
								if($ret === false) {
									...
									echo '<br/><p>For database setup </p><a href="/migrate" class="btn btn-success">Click Install</a>';
								}
					}else{
						die('<div class="alert alert-danger" role="alert">Process Broken Please Contact andministrator! or try again</div>');
					}
