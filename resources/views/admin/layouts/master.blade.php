    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}">
                ...
                <div class="sidebar-brand-text mx-3">Visit Website<sup></sup></div>
            </a>
             ...
             <li class="nav-item" style="display:none">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('/dashboard/posts')}}">All Posts</a>
                        <a class="collapse-item" href="{{ url('/dashboard/posts/create') }}">Add New</a>
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ url('/dashboard/pages')}}">All Pages</a>
                    <a class="collapse-item" href="{{ url('/dashboard/pages/create') }}">Add New</a>
                </div>
            </div>
            </li>
            ...
            <!-- Divider -->
            <hr class="sidebar-divider d-none" style="display:none">
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item" style="display:none">
                ...
                <div id="collapseSliders" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Create Slider:</h6>
                        <a class="collapse-item" href="{{ url('/dashboard/sliders') }}">All Sliders</a>
                        <a class="collapse-item" href="{{ url('/dashboard/sliders/create') }}">Add New</a>
                    </div>
                </div>
            </li>
            ...
            <div id="collapseAds" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Create Ads:</h6>
                    <a class="collapse-item" href="{{ url('/dashboard/ads')}}">All Ads</a>
                    <a class="collapse-item" href="{{ url('/dashboard/ads/create') }}">Add New</a>  
                </div>
            </div>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>LaraPress CMS V 0.1 Copyright &copy; Your Website 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
